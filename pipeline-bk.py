...
"""
Sequential execution of model experiments, removed joblib parallelism to avoid errors.
"""
...
def run_pipeline(
    ...
    # Sequential execution of experiments (no parallelism)
    results = []
    for idx, exp in enumerate(experiments):
        res = _run_and_plot(idx, exp, X_train, y_train, X_test, y_test, epochs, plots_dir)
        if res is not None:
            results.append(res)
